...
> While _eidon_ is usable and has been used successfully in [research projects](projects), it is still under development. This means that some features may be missing, and other features may improve in the future. You can help us out by [creating feature requests or bug reports](https://github.com/saeub/eidon/issues), or by [contributing code](https://github.com/saeub/eidon/pulls)!
